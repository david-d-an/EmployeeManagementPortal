...
//     public class EmployeeDetailCurrentController : ControllerBase
//     {
//         private ILogger<EmployeeDetailController> _logger;
//         private IRepository<VwEmpDetailsCurrent> _employeeDetailCurrentRepository;
...
//         public EmployeeDetailCurrentController(
//             ILogger<EmployeeDetailController> logger,
//             IRepository<Employees> employeeRepository,
//             IRepository<VwEmpDetailsCurrent> employeeDetailCurrentRepository,
...
//             this._employeeDetailCurrentRepository = employeeDetailCurrentRepository;
...
//         [HttpGet]
//         public ActionResult<IEnumerable<VwEmpDetailsCurrent>> Get()
//         {
//             return Ok(_employeeDetailCurrentRepository.GetAsync());
//         }
        
//         [HttpGet("{id}")]
//         public async Task<ActionResult<VwEmpDetailsCurrent>> Get(int id)
//         {
//             return await _employeeDetailCurrentRepository.GetAsync(id.ToString());
//         }

//         [HttpPut("{id}")]
//         public async Task<ActionResult<VwEmpDetailsCurrent>> Put(int id, VwEmpDetails employeeDetailUpdateRequest)
//         {
...
//             VwEmpDetailsCurrent result = await _employeeDetailCurrentRepository.GetAsync(id.ToString());

//             return result;
//         }

//         [HttpPost]
//         public async Task<ActionResult<VwEmpDetailsCurrent>> Post(VwEmpDetails employeeDetailCreateRequest) 
//         {
...
//             VwEmpDetailsCurrent result = await _employeeDetailCurrentRepository.GetAsync(empNo.Value.ToString());
